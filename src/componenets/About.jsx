    ...
    return (
        <>
            <div name= "About" className=' max-w-screen-2xl container mx-auto px-4 md:px-20  my-20'>
                ...
                <span>SSC (10th)
                    Navbharat High-School, Khed | 88.00% | 2019
                </span><br /><br />
                ...
                <span>
                    <p>Intern</p>
                    <p>Prodigy InfoTech (CyberSecurity Project Intern) | Aug 2024 - Sep 2024 </p>
                </span><br />

                <span>
                    <p>Intern</p>
                    <p>InterPe (Java Project Intern) | July 2024 - Aug 2024 </p>
                </span>

                <br />
                <br />
                <h1 className='text-purple-800 font-semibold text-xl'>Certificaton </h1><br /><br />
                ...
                <span className='font-semibold '> DataScience And Machine Learning (YBI)</span><a href="https://drive.google.com/file/d/1c4oU62eBvVhGDp4YFfPktaWQe2tCI9Md/view?usp=drivesdk" className='cursor-pointer text-blue-500 italic'>visit</a><br /><br />

                <span className='font-semibold '> Python (Udemy)</span><a href="https://drive.google.com/file/d/1ynRh7LxHb_2pdD_y8POte-zdUpyJxyRx/view?usp=drivesdk" className='cursor-pointer text-blue-500 italic'>visit</a><br /><br />

                <span className='font-semibold '>JAVA (Udemy)</span><a href="https://drive.google.com/file/d/1zdNP7-X2Rpo9pW-wI5oX5-Qx-s0aZwGi/view?usp=drivesdk" className='cursor-pointer text-blue-500 italic'>visit</a><br /><br />
